...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main id="top">
      ...
      {queryState==='ready'&&mart&&<><section className="metrics">{metrics.map(metric => {const isSnapshot=snapshotMetrics.has(metric.id);return <MetricCard key={metric.id} metric={metric} lang={lang} prior={isSnapshot?(lang==='pt'?'snapshot atual':'current snapshot'):comparisonLabel} comparisonAvailable={comparisonAvailable&&!isSnapshot} />})}</section>
